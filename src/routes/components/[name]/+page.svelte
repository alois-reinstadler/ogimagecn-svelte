...
<article class="max-w-4xl">
  <a href={`${base}/components/`} class="text-muted-foreground text-sm">← Alle Einsatzfälle</a>
  ...
  <div class="bg-dots mt-10 rounded-lg border p-3 sm:p-6">
    <img
      ...
      width="1200"
      height="630"
      alt={`${data.meta.title} Vorschau`}
      class="w-full rounded border shadow-xl"
    />
  </div>

  <section class="mt-12">
    <h2 class="display text-2xl">Beispielszenario</h2>
    <p class="text-muted-foreground mt-3 leading-7">
      Diese Vorschau verwendet konkrete Inhalte und lokale Beispielassets. Im Projekt ersetzt du sie durch Daten aus
      deinem Katalog, CMS oder Backend.
    </p>
    <div class="mt-4 overflow-x-auto rounded border">
      <table class="w-full text-left text-sm">
        <thead class="bg-muted"><tr><th class="p-3 font-medium">Prop</th><th class="p-3 font-medium">Beispielwert</th></tr></thead>
        <tbody>
  ...
  <section class="mt-12">
    <h2 class="display text-2xl">Installieren</h2>
    <div class="mt-4">
  ...
  <section class="mt-12">
    <h2 class="display text-2xl">Mit eigenen Daten verwenden</h2>
    <div class="mt-4"><CodeBlock code={usage} filename="og.ts" /></div>
  </section>

  <section class="mt-12">
    <h2 class="display text-2xl">Technische Standard-Props</h2>
    <p class="text-muted-foreground mt-3">
      Der API-Name <code class="font-mono">{data.meta.template}</code> und seine Upstream-Standardwerte bleiben für
      Kompatibilität unverändert. Zusätzlich akzeptiert jede Komponente ein optionales
      <code class="font-mono">overlay</code>-Snippet.
    </p>
    <div class="mt-4 overflow-x-auto rounded border">
      <table class="w-full text-left text-sm">
        <thead class="bg-muted"><tr><th class="p-3 font-medium">Prop</th><th class="p-3 font-medium">Standardwert</th></tr></thead>
        <tbody>
